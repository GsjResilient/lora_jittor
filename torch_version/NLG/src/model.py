...
class Attention(nn.Module):
    ...
    def forward(self, x, history=None, layer_past=None, len_past=None):
        ...
        if layer_past is not None:
            ...
            if len_past is None:
                # print(layer_past[0].shape,layer_past[0].transpose(-2, -1).shape,'哥们儿'*50)
...
class GPT2Model(nn.Module):
    ...
    def forward(
        ...
        # print(input_ids.shape, 'qian' * 50)
        input_ids = input_ids.view(-1, input_ids.size(-1))
        position_ids = position_ids.view(-1, position_ids.size(-1))
        # print(len(input_ids), type(input_ids), 'here' * 50)
...
class GPT2LMModel(nn.Module):
    ...
    def forward(
        ...
        # print(len(input_ids), 'hahaahahahah' * 100)
