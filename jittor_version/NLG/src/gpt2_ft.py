...
if __name__ == '__main__':
    ...
    jt.set_global_seed(args.random_seed) #纠结一下这个要不要
    ...
    if args.max_step is None:# scheduler要用的参数 每max_step步就调整一次学习率
    ...
    paint(train_loss_list,f"{os.path.normpath(args.train_data).split(os.sep)[-2]}_loss")
